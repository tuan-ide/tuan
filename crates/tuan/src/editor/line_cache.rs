...
// This file is significantly a copy of the linecache from Tau
// https://gitlab.gnome.org/World/Tau/-/blob/master/src/tau-linecache/src/linecache.rs

use log::{error, trace};
use std::cmp::min;
use tuan_rpc::{OperationType, StyleDef, Update};
...
impl From<tuan_rpc::Line> for Line {
    fn from(x: tuan_rpc::Line) -> Self {
        Self {
            text: x.text,
            cursor: x.cursor,
            styles: x.styles,
